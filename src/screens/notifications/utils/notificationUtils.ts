...
export const translateNotificationTitle = (title?: string): string => {
  ...
  const exactTranslations: Record<string, string> = {
    ...
    'sleep reminder': 'Rappel de sommeil',
    'sleep': 'Sommeil',
    'meal reminder': 'Rappel de repas',
    'workout reminder': "Rappel d'entraînement",
    'reminder notification': 'Notification de rappel',
  ...
  const patterns: Array<{ en: RegExp; fr: string }> = [
    ...
    { en: /hydration reminder/gi, fr: "Rappel d'hydratation" },
    { en: /\bhydration\b/gi, fr: 'Hydratation' },
    { en: /sleep reminder/gi, fr: 'Rappel de sommeil' },
    { en: /\bsleep\b/gi, fr: 'Sommeil' },
    { en: /meal reminder/gi, fr: 'Rappel de repas' },
    { en: /workout reminder/gi, fr: "Rappel d'entraînement" },
