    ...
    <>
      ...
      >
        ...
        <View style={styles.section}>
          ...
          onChartMeasurementPress={handleMeasurementClick}
      ...
      {/* Comparaison : baseline = initiale ou mesure précédente (logique dans useProgressScreen) */}
      {showComparisonModal &&
        selectedMeasurementForComparison &&
        comparisonBaselineMeasurement && (
          <MeasurementComparisonBottomSheet
            visible={showComparisonModal}
            firstMeasurement={comparisonBaselineMeasurement}
            selectedMeasurement={selectedMeasurementForComparison}
            onClose={() => {
              setShowComparisonModal(false);
              setSelectedMeasurementForComparison(null);
              setComparisonBaselineMeasurement(null);
            }}
            getPhotoUrl={getPhotoUrl}
            initialProgressPhoto={initialProgressPhoto}
          />
