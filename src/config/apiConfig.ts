...
export const API_CONFIG = {
  ...
  endpoints: {
    ...
    // Device endpoints
    device: {
      register: '/devices/register',      // Enregistrer/mettre à jour les infos de l'appareil
      list: '/devices',                   // Lister les appareils de l'utilisateur
      remove: (deviceId) => `/devices/${deviceId}`, // Supprimer un appareil
    },
